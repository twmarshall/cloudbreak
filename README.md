...
# Warning for upgrading version 2.9

Due to a technology change (upgrading docker-compose) the previous database volumes will become unreachable after upgrading to the latest version of Cloudbreak 2.9.
