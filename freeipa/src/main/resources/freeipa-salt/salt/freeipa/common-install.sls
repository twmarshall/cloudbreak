fix_next_update_grace_period:
  file.replace:
    - name: /var/lib/pki/pki-tomcat/ca/conf/CS.cfg
    - pattern: ^ca[.]crl[.]MasterCRL[.]nextUpdateGracePeriod=.*
    - repl: ca.crl.MasterCRL.nextUpdateGracePeriod=60
    - unless: grep "^ca[.]crl[.]MasterCRL[.]nextUpdateGracePeriod=60$" /var/lib/pki/pki-tomcat/ca/conf/CS.cfg
